...
import fr.inra.maiage.bibliome.util.pattern.tabular.parser.ParseException;
import fr.inra.maiage.bibliome.util.pattern.tabular.parser.TabularPatternParser;
...
import fr.inra.maiage.bibliome.util.yatea.pattern.ChunkSequencePatternMapper;
import fr.inra.maiage.bibliome.util.yatea.pattern.ParsingPattern;
...
public class TabularPattern extends CLIOParser {
	...
	public void loadYateaPatterns(String file) throws IOException, URISyntaxException, fr.inra.maiage.bibliome.util.yatea.pattern.parser.ParseException {
		yateaPatterns = true;
